"""new Image processor for Qwen2-VL."""
...
def create_preprocess(adv_image):
    ...
    def my__preprocess(
        ...
        if patches.shape[0] % temporal_patch_size != 0:
            ...
            # repeat 最后一个 patch
            last_patch = patches[-1].unsqueeze(0)  # [1, C, H, W]
            repeats = last_patch.repeat(pad_len, 1, 1, 1)  # [pad_len, C, H, W]
        ...
        # print(patches.shape)
        # print(f"grid_t: {grid_t}, grid_h: {grid_h}, grid_w: {grid_w}, channel: {channel}, temporal_patch_size: {temporal_patch_size}, patch_size: {patch_size}, merge_size: {merge_size}")
        ...
        # print(f"patches.shape after permute: {patches.shape}")
        ...
        # print("patches.shape:", patches.shape)
        # print("flatten_patches.shape:", flatten_patches.shape)
    ...
    return my__preprocess, my_preprocess
